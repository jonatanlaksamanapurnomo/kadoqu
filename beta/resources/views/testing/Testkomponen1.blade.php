...
<div>
	...
	<div class="information-blocks">
		...
		<div id="subscribe-popup-4" class="overlay-popup visible active" style="background-color: #8f8d8d40;">
			<div class="overflow">
				<div class="table-view">
					<div class="cell-view">
						<div class="close-layer"></div>
		...
		<!-- Lacak Pesanan -->
		<div id="subscribe-popup-7" class="overlay-popup" style="background-color: #8f8d8d40;">
			<div class="overflow">
				<div class="table-view">
					<div class="cell-view">
						<div class="close-layer"></div>
						<div class="popup-container popup-relative lacak-pesanan-modals">
							<div style="display: flex; background: #01998d; width: 100%; height: 50px; flex-direction: column;">
								<div style="font-size: 30px; font-weight: 600; color: #fff; margin-left: 0; margin-top: 10px; text-align: center;">LACAK PESANAN</div>
							</div>
							<div style="display: flex; background-color: #e8faf6; height: 30%;">
								<div style="display: flex; position: relative; left: 2%; top: 7%;">
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> Pesanan diterima
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> [KEPALA GADING, JAKARTA] Delivered
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> [JAKARTA] Received on destination
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> [GATEWAY, JAKARATA] On transit
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> [BANDUNG] Manifested
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> [BANDUNG] On process
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> Pesanan dikirim
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
							...
							<div>
								<div style="display: flex; height: 20px; margin-top: 2%;">
									<div style="margin-left: 50px;">
										<i class="fa fa-check-circle" style="color: #01998d; font-size: 20px; margin-right: 10px;"></i> Pesanan dibuat
									</div>
									<div style="position: absolute; right: 9%; text-align: right;">
										26 Februari 2018<br>16.04 WIB
									</div>
