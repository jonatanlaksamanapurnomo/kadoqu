...
class Magestore_Giftwrap_Block_Adminhtml_Sales_Order_View_Giftwrap extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface {
