...
class Magestore_Giftwrap_Block_Adminhtml_Sales_Order_Creditmemo_View_Giftwrap extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    public function _construct() {
        parent::_construct();
        $this->setTemplate('giftwrap/sales/order/creditmemo/view/giftwrap.phtml');
    }
    ...
    public function getOrderItemGiftwrap($orderId = null) {
        ...
        foreach ($itemcollection as $itemcol){
            if($itemcol->getQty() != 0 && $itemcol->getBasePrice() != 0){
                $lastId = $itemcol->getOrderItemId();
            }
        }
