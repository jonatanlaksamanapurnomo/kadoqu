...
class Magestore_Giftwrap_Block_Adminhtml_Sales_Order_Invoice_View_Giftwrap extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    public function _construct() {
        parent::_construct();
        $this->setTemplate('giftwrap/sales/order/invoice/view/giftwrap.phtml');
    }
