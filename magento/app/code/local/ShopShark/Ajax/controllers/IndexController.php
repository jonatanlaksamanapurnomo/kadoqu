	...
	public function compareAction(){
		...
		if ($productId = (int) $this->getRequest()->getParam('product')) {
			...
			if ($product->getId()/* && !$product->isSuper()*/) {
                ...
                $header_block = $this->getLayout()->getBlock('catalog.compare.header');
				if($header_block) {
                	$header_block->setTemplate('catalog/product/compare/header.phtml');
					$header = $header_block->toHtml();
					$response['header_block'] = $header;
				}
			}
		}
