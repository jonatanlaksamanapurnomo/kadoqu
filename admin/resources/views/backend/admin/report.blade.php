                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-daterange input-group" id="m_datepicker_5">
                            <input type="text" class="form-control m-input" name="start" placeholder="Tanggal Awal">
...
function getData(start_date,end_date){
    $.ajax({
        url : "/api/dashboard?start_date="+start_date+"&end_date="+end_date,
        methode : "GET",
...
$("input[name='start'],input[name='end']").on("change",function(){
    getData($(this).val(),$("input[name='end']").val());
})
$.ajax({
    url : "/api/dashboard?date=today",
    methode : "GET",
    success : function(data){
        $("#total_order").html(data.order);
        $("#total_item").html(data.item);
