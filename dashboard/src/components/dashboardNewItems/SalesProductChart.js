...
class SalesProductChart extends React.Component {
  state = {
    start: {
    ...
    return (
      ...
      >
        {({ loading, error, data }) => {
          ...
          const monthlyRevenues = data.getMonthlySalesProduct;
          const chartData = {
            labels: Array.from(
              {
                length:
          ...
          return (
            <Card className="chart-container">
              <Card.Body>
                ...
                <Row className="chart-title-section">
                  <Col xs={6}>
                    <h5 className="font-weight-bold mb-0">Product</h5>
                  </Col>
                  <Col>
                          ...
                          <Select
                            ...
                            value={
                              this.state.productId
                                ? {
                                    label: data.getProductsDashboard.find(
                                      e => e.id === this.state.productId
                                    ).name,
