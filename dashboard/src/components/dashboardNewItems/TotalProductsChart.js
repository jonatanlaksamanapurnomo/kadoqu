...
const QUERY_GET_TOTAL_PRODUCT = gql`
  query getTotalProduct(
    ...
    getTotalProductCounts(startDate: $startDate, endDate: $endDate)
  }
`;

class TotalProductsChart extends React.Component {
  state = {
    start: {
    ...
    return (
      ...
      >
        {({ loading, error, data }) => {
          ...
          const products = data.getTotalProductCounts;
            ...
            <Card className="chart-container">
              <Card.Body>
                <Row className="chart-title-section">
                  <Col>
                    <h4 className="font-weight-bold mb-0">Total Product</h4>
                  </Col>
                    ...
                    <div className="text-center mb-5">
                      ...
                      <div className="d-flex justify-content-even align-items-center">
                        <div xs={6} className="text-warning">
                          ...
                          <div className="small">new products</div>
                        </div>
                      </div>
                    </div>
                  </Col>
