...
const QUERY_GET_TOTAL_PRODUCT_WISHLIST = gql`
  query getTotalProductWishlistCounts(
    $startDate: ParsedDateInput
    $endDate: ParsedDateInput
  ) {
    getTotalProductWishlistCounts(startDate: $startDate, endDate: $endDate)
  }
`;

class TotalProductsWishlist extends React.Component {
  state = {
    start: {
  ...
  render() {
    ...
    return (
      <Query
        query={QUERY_GET_TOTAL_PRODUCT_WISHLIST}
        variables={{
      ...
      >
        {({ loading, error, data }) => {
          ...
          const products = data.getTotalProductWishlistCounts;
          ...
          const chartData = {
            ...
            datasets: [
              {
                type: "line",
                label: "Products Wishlist Per Month",
                lineTension: 0.1,
                fill: false,
                    ...
                    <div className="text-center mb-5">
                      ...
                      <div className="d-flex justify-content-even align-items-center">
                        <div xs={6} className="text-warning">
                          ...
                          <div className="small">new products Wishlist</div>
                        </div>
                      </div>
                    </div>
                  </Col>
...
export default TotalProductsWishlist;
