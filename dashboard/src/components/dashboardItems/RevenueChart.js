...
const QUERY_GET_MONTHLY_REVENUES = gql`
  query getMonthlyRevenues(
    $startDate: ParsedDateInput
    $endDate: ParsedDateInput
  ) {
    getMonthlyRevenues(startDate: $startDate, endDate: $endDate)
    getMonthlyProfits(startDate: $startDate, endDate: $endDate)
  }
`;
    ...
    return (
      ...
      >
        {({ loading, error, data }) => {
          ...
          const monthlyRevenues = data.getMonthlyRevenues;
          const monthlyProfits = data.getMonthlyProfits;
            ...
            datasets: [
              {
                ...
                borderWidth: 1,
                borderDash: [8, 5],
                data: new Array(monthlyRevenues.length).fill(100000000)
              },
              {
                label: "Revenue",
                type: "line",
              ...
              },
              {
                ...
                borderWidth: 2,
                data: Array.from(
                  { length: monthlyProfits.length },
                  (e, index) => monthlyRevenues[index] - monthlyProfits[index]
                )
              }
            ]
          };
            ...
            <Card className="chart-container">
              <Card.Body>
                <Row className="chart-title-section">
                  <Col xs={3}>
                    <h4 className="font-weight-bold mb-0">Revenue</h4>
                  </Col>
