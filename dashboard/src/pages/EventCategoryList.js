...
import { QUERY_GET_EVENT_CATEGORIES } from "../gql/event-category";
                  ...
                  if (result.value) {
                    this.props.client
                      .mutate({
                        ...
                        refetchQueries: [
                          {
                            query: QUERY_GET_EVENT_CATEGORIES
                          }
                        ]
                      })
                      .then(() =>
    ...
    return (
      <React.Fragment>
        ...
        <AddStoreCategoryModal
          ...
          refetchQueries={[{ query: QUERY_GET_EVENT_CATEGORIES }]}
        />
      </React.Fragment>
    );
  }
...
export default withApollo(EventCategoryList);
