                      ...
                      <div className="product-list-container">
                            ...
                            >
                              ...
                              <div className="d-inline-block">
                                {resProducts.error || resProducts.loading
                                  ? 0
                                  : resProducts.data.searchProducts.length}{" "}
                                Produk
                              </div>
                            </div>
                          ) : (
                        ...
                        <div className="row justify-content-center m-0">
                          ...
                          {!resProducts.loading && !resProducts.error && (
                            ...
                            >
                              {resProducts.data.searchProducts.length === 0 ? (
                                ...
                                <React.Fragment>
                                  {!this.props.isMobile ? (
                                    ...
                                    >
                                      <ListOfProducts
                                        products={
                                          resProducts.data.searchProducts
                                            .products
                                        }
                                        query={query}
                                        recommendedMerchant={
                                    ...
                                    <ListOfProducts
                                      products={
                                        resProducts.data.searchProducts.products
                                      }
                                      query={query}
                                      recommendedMerchant={
                                        this.state.recommendedMerchant
                              ...
                              <PaginationButtons
                                ...
                                itemsLength={this.handlepaginationpage(resProducts.data.searchProducts.length)}
